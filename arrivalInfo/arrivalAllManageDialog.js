...
module.exports = function(intentRequest, callback) {
  ...
  if(aaSource === null && aaAirline === null && aaArrivalDate === null) {
    ...
    return validateArrFlightInfo(intentRequest.sessionAttributes, intentRequest.currentIntent.slotDetails, aaArrivalDate, aaSource, aaAirline).then(validationResult => {
